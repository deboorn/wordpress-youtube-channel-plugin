    ...
    <div class="row series-list">
        ...
        <?php foreach((array)$result['items'] as $item): $count++; ?>
            <div class="<?php echo $attributes['columns']; ?>" style="<?php echo $attributes['break'] && $count%3 == 0 ? "" : ""; ?>">
                <a class="img-thumbnail" href="<?php echo $attributes['videopageurl'] . (strpos($attributes['videopageurl'], '?') === false ? "?v=" : "&v=") . $item['snippet']['resourceId']['videoId'] . '&t=' . $item['snippet']['title']; ?>">
